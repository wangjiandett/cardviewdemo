...
public class RelativeCardView extends RelativeLayout {
    ...
    public RelativeCardView(@NonNull Context context) {
        this(context, null);
    }

    public RelativeCardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.cardViewStyle);
    }

    public RelativeCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
